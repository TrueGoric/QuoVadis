...
goog.provide('proto.GetVehiclesResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.VehicleInfo');
...
proto.GetVehiclesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.VehicleInfo.toObject, includeInstance)
  };
...
proto.GetVehiclesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.VehicleInfo;
      reader.readMessage(value,proto.VehicleInfo.deserializeBinaryFromReader);
...
proto.GetVehiclesResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.VehicleInfo.serializeBinaryToWriter
    );
  }
};
...
proto.GetVehiclesResponse.prototype.getVehiclesList = function() {
  return /** @type{!Array<!proto.VehicleInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.VehicleInfo, 1));
};
